...
const ResendActiveAccount = () => {
    let[email,setEmail] = useState("");
    let {resentActiveToken: resentActiveTokenCtx} = useContext(AuthenContext)
    ...
    let activeTokenUser = async () =>{
        const response = await resentActiveTokenCtx(email)
                        ...
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <div>
                                <form className="space-y-4 md:space-y-6" action="#">
                                    ...
                                    />
                                    {status ? null : (
                                        <p className={`text-${ code === 404 ? 'red' : 'green'}-500 text-sm`}>{msgResponse}</p>
                                    )}
...
export default ResendActiveAccount;