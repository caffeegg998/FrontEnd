                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6" action="#">
                            <div>
                                ...
                                {status ? null : (
                                    <p className={'text-red-500 text-sm'}>{msgResponse}{code === 402 || code === 1?null:(<a className={'text-blue-400 underline'} href='/resend-active-account'> Kích hoạt tài khoản</a>)}</p>
                                )}
                            ...
                            <button type="button"
                                    className="w-full border-2 border-2 text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                                    onClick={() => handleLogin()}>
                                {code === 1 ? (
                                    <>
